    ...
    <div className="h-screen flex items-center justify-center">
        <div className='flex flex-col gap-4 w-full max-w-xs'>
          ...
          <h1 className="text-white">Vamos Jogar? Coloque sua Música abaixo</h1>
              ...
              <input
                  className="border border-zinc-200 shadow-sm rounded h-10 px-3 max-w-xs"
                  type="text"
              ...
              <button onClick={() => handleSubmit(onSubmit)()} className="bg-emerald-500 rounded font-semibold text-white h-10" type='submit'>Identificar Plataforma</button>
          </div>
